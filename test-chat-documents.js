...
async function testChatWithDocuments() {
    console.log('🔍 Testando chat com busca de documentos...');
    
    try {
        const response = await axios.post(API_URL, {
            message: "Busque documentos sobre políticas internas da empresa",
