-- ===================================================================
-- MIGRAÇÃO 020 V3: Segregação FINAL e SIMPLES
-- Data: 15 de janeiro de 2025
-- Descrição: Versão mais simples e direta que funciona
-- ===================================================================
...
BEGIN
  ...
  -- Regras:
  -- 1. Se trilha tem registro com departamento APENAS → verifica se colaborador tem esse departamento
  -- 2. Se trilha tem registro com cargo APENAS → verifica se colaborador tem esse cargo
  -- 3. Se trilha tem registro com AMBOS juntos → exige que colaborador tenha AMBOS
  
  -- Verificar se existe um registro na trilha_segmentacao que bate com o colaborador
  RETURN EXISTS (
    ...
    WHERE ts.trilha_id = p_trilha_id
      ...
      AND (
        ...
        -- Colaborador precisa ter esse departamento
        ...
        -- Colaborador precisa ter esse cargo
...
COMMENT ON FUNCTION colaborador_tem_acesso_trilha IS 'Verifica se colaborador tem acesso baseado no que está marcado na trilha_segmentacao';
